        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <h5 class="card-header"><?= $dataclass['name']; ?>
                            <!-- Button trigger modal -->
                        </h5>
                        <div class="card-body">
                            <h5 class="card-title">
                                <!-- <audio controls>
                                    <source src="../../upload/audio/<?= $dataclass['audio']; ?>">
                                </audio> -->

                                <div class="player">
                                    <img id="button" onclick="togglePlay()" src="images/file-audio.svg">
                                    <audio>
                                        <source src="../../upload/audio/<?= $dataclass['audio']; ?>">
                                    </audio>
                                </div>
                        ...
                        <div class="modal-footer">
                            <a href="pre-test?id=<?= $dataclass['main_id']; ?>" class="btn btn-primary"> ถัดไป <i class="fa-solid fa-circle-chevron-right"></i></a>
                        </div>
                    </div>
