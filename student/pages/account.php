...
// data_loginuser
$stmt = $conn->query("SELECT * FROM db_user WHERE user_id=$_SESSION[user_id]");
$stmt->execute();
$data = $stmt->fetch();
                ...
                <div class="container-fluid">
                    <div class="card">
                        ...
                        <?php if (isset($_SESSION['error'])) { ?>
                            ...
                            ?>
                        <?php } ?>
                        <h5 class="card-header"><i class="fa-solid fa-user-pen"></i> ข้อมูลส่วนตัว</h5>
                        <form action="update_account" method="post">
                            <div class="card-body">
                                <input type="text" class="form-control" value="<?= $data['user_id']; ?>" name="user_id" style="display: none;">
                                <div class="mb-3">
                                    <div class="row">
                                        <div class="col" style="max-width:150px ;">
                                            ...
                                            <select class="form-control" id="exampleFormControlSelect1" name="prefix" required>
                                                <option value="<?= $data['prefix']; ?>"><?= $data['prefix']; ?></option>
                                        ...
                                        <div class="col" style="max-width:660px ;">
                                            ...
                                            <input type="text" class="form-control" placeholder="First name" required value="<?= $data['f_name']; ?>" name="f_name" aria-label="First name">
                                        </div>
                                        <div class="col">
                                            <label for=" " class="form-label">นามสกุล</label>
                                            <input type="text" class="form-control" placeholder="Last name" required value="<?= $data['l_name']; ?>" name="l_name" aria-label="Last name">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            ...
                                            <input type="date" class="form-control" placeholder="Birthday" required value="<?= $data['birthday']; ?>" name="birthday" aria-label="birthday">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            ...
                                            <input type="text" class="form-control" placeholder="Username" required value="<?= $data['username']; ?>" name="username" disabled aria-label="Username">
                                            <input type="hidden" class="form-control" placeholder="Username" required value="<?= $data['username']; ?>" name="username"  aria-label="Username">
                                        </div>
                                        <div class="col">
                                            <label for=" " class="form-label">รหัสผ่าน</label>
                                            <input type="password" class="form-control" placeholder="Password" required id="password" value="<?= $data['password']; ?>" name="password" aria-label="Password">
