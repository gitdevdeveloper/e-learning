            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="./mindmap" class="nav-link active">
                        ...
                        <li class="nav-item">
                            <a href="#" onclick="logout()" class="nav-link  btn-danger">
                                <i class="nav-icon fa-solid fa-right-from-bracket" wid style="color: #fff;"></i>
                                <p style="color: #fff;">
                                    ออกจากระบบ
                                </p>
                            </a>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">แผนผังสรุป</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item active">แผนผังสรุป</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="card">
                        <h5 class="card-header">แผนผังสรุป</h5>
                        <div class="card-body">
                            <div class="grid-mindmap">
                                <?php
                                ...
                                if (!$db_mindmap) {
                                    ...
                                    foreach ($db_mindmap as $mindmap) {
                                ?>
                                        <a href="../../upload/mindmap/<?= $mindmap['mindmap']; ?>" data-fancybox="gallery">
                                            <img src="../../upload/mindmap/<?= $mindmap['mindmap']; ?>" alt="">
                                            <h3><?= $mindmap['name']; ?></h3>
                                        </a>
