        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">คะแนน</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item active">คะแนน</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                ...
                <div class="container-fluid">
                    <div class="card">
                        ...
                        <?php if (isset($_SESSION['error'])) { ?>
                            ...
                            ?>
                        <?php } ?>
                        <h5 class="card-header"><i class="fa-solid fa-chart-simple"></i> คะแนนก่อนเรียน
                        </h5>
                        <div class="card-body">
                            <table class="table table-bordered table-hover" id="example1">
                                ...
                                <tbody>
                                    ...
                                    $stmt = $conn->query("SELECT * FROM score_pretest INNER JOIN db_main_lesson ON score_pretest.s_main_id = db_main_lesson.main_id
                                       WHERE score_pretest.user_id = '$data[user_id]' ORDER BY db_main_lesson.main_id   DESC  ");
                                    $stmt->execute();
                    ...
                    <div class="card">
                        <h5 class="card-header"><i class="fa-solid fa-chart-simple"></i> คะแนนหลังเรียน
                        </h5>
                        <div class="card-body">
                            <table class="table table-bordered table-hover" id="example1">
                                <thead>
                                ...
                                <tbody>
                                    ...
                                    $stmt = $conn->query("SELECT * FROM score_posttest INNER JOIN db_main_lesson ON score_posttest.s_main_id = db_main_lesson.main_id
                                       WHERE score_posttest.user_id = '$data[user_id]' ORDER BY db_main_lesson.main_id   DESC  ");
                                    $stmt->execute();
