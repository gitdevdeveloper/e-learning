        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="pages/account" class="d-block"><?= $data['f_name'] . " " . $data['l_name']; ?></a>
                    </div>
                </div>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="pages/learning" class="nav-link ">
                        ...
                        <li class="nav-item">
                            <a href="pages/mindmap" class="nav-link ">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="grid-course">
                                    ...
                                    ?>
                                                <a href="pages/classroom?id=<?= $allmain['main_id']; ?>">
                                                    <div class="card">
