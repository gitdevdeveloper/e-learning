...
if (isset($_GET['posttestId'])) {
    $delete_id = $_GET['posttestId'];
    $deletestmt = $conn->query("DELETE FROM db_posttest WHERE post_id = $delete_id");
    $deletestmt->execute();

    if ($deletestmt) {
        $delete_id = $_GET['posttestId'];
        $deletestmt = $conn->query("DELETE FROM db_posttest_choice WHERE post_id = $delete_id");
        $deletestmt->execute();

        echo "<script>alert('Data has been deleted successfully');</script>";
        header("refresh:3; url=post-test");
    }
}
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item active">แบบทดสอบหลังเรียน</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                ...
                <div class="container-fluid">
                    <div class="card">
                        ...
                        <?php if (isset($_SESSION['error'])) { ?>
                            ...
                            ?>
                        <?php } ?>
                        <h5 class="card-header"><i class="fa-solid fa-table"></i> แบบทดสอบหลังเรียน
                            ...
                            <table class="table table-bordered table-hover" id="example1">
                                ...
                                <tbody>
                                    ...
                                    if (!$db_main_lesson) {
                                        ...
                                        foreach ($db_main_lesson as $posttest_main) {
                                            $num++;
                                    ?>
                                            <tr>
                                                <th scope="row" style="width: 100px;"><?= $num; ?></th>
                                                <td><?= $posttest_main['name']; ?></td>
                                                <td style="width: 100px;">
                                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal<?= $posttest_main['main_id']; ?>">
                                                        <i class="fa-solid fa-eye"></i>
                                                    </button>

                                                    <!-- Modal -->
                                                    <div class="modal fade" id="exampleModal<?= $posttest_main['main_id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    $stmt2 = $conn->query("SELECT * FROM db_posttest INNER JOIN  db_posttest_choice ON  db_posttest.post_id = db_posttest_choice.post_id 
                                                                                                                     WHERE db_posttest.main_id = '$posttest_main[main_id]'");
                                                                    $stmt2->execute();
                                                                    ...
                                                                    ?>
                                                                            ...
                                                                            <div class="mb-3">
                                                                                <label for="formGroupExampleInput" class="form-label">ข้อ <?= $choicenumber; ?> <a href="update_question_post?question=<?= $datapretest['question']; ?>">แก้ไข</a>
                                                                                    <a href="JavaScript:if(confirm('คุณเเน่ใจใช่ไหมที่จะลบคำถามนี้ ?')==true){window.location='post-test?posttestId=<?php echo $datapretest["post_id"]; ?>';}" style="color:red;">ลบ</a>

                                                                                </label>
                                                                                <input type="text" class="form-control" disabled readonly id="formGroupExampleInput" name="question" value="<?= $datapretest['question']; ?>" required>
                                                                            </div>
                                                                            <!-- ก -->
                                                                            ...
                                                                            ?>
                                                                                ...
                                                                                <div class="choice" style="margin-left:50px ;">
                                                                                    <div class="input-group mb-3">
                                                                                        <span class="input-group-text" id="basic-addon1"><i class="fa-solid fa-circle-check text-success"></i></span>
                                                                                        <input type="text" class="form-control " disabled readonly value="<?= $datapretest['choice1']; ?>" name="choice1" required>
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            ?>
                                                                                ...
                                                                                <div class="choice" style="margin-left:50px ;">
                                                                                    <div class="input-group mb-3">
                                                                                        <span class="input-group-text" id="basic-addon1"><i class="fa-solid fa-circle-check text-success"></i></span>
                                                                                        <input type="text" class="form-control " disabled readonly value="<?= $datapretest['choice2']; ?>" name="choice2" required>
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            ?>
                                                                                ...
                                                                                <div class="choice" style="margin-left:50px ;">
                                                                                    <div class="input-group mb-3">
                                                                                        <span class="input-group-text" id="basic-addon1"><i class="fa-solid fa-circle-check text-success"></i></span>
                                                                                        <input type="text" class="form-control " disabled readonly value="<?= $datapretest['choice3']; ?>" name="choice3" required>
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            ?>
                                                                                ...
                                                                                <div class="choice" style="margin-left:50px ;">
                                                                                    <div class="input-group mb-3">
                                                                                        <span class="input-group-text" id="basic-addon1"><i class="fa-solid fa-circle-check text-success"></i></span>
                                                                                        <input type="text" class="form-control " disabled readonly value="<?= $datapretest['choice4']; ?>" name="choice4" required>
                                                                                    </div>
                                                                                </div>
    ...
    <div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="check_add_posttest" method="post">
                    <div class="modal-body">
                        <div class="mb-3">
