<?php 
    ...
    if(isset($_POST['pretest'])){
        ...
        $sql = $conn->prepare("INSERT INTO db_pretest (pre_id,main_id,question,answer) VALUES(:pre_id,:main_id,:question,:answer)" );
            ...
            if ($sql){
                ...
                $sql2 = $conn->prepare("INSERT INTO db_pretest_choice (choice_id,pre_id,choice1,choice2,choice3,choice4) VALUES(:choice_id,:pre_id,:choice1,:choice2,:choice3,:choice4)" );
