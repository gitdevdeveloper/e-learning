...
if (isset($_GET['map_id'])) {
    $delete_id = $_GET['map_id'];
    $deletestmt = $conn->query("DELETE FROM db_mindmap WHERE id = $delete_id");
    $deletestmt->execute();
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalmap<?= $num; ?>">
                                                        ...
                                                        <form action="update_main_lesson" method="post" enctype="multipart/form-data">
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mb-3" style="display:none ;">
                                                                    ...
                                                                    <input class="form-control" type="text" value="<?= $data_main['video']; ?>" name="video2">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width:5% ;">
                                                    <button type="button" class="btn btn-danger" onclick="mindmap<?= $data_mindmap['main_id']; ?>()"><i class="fas fa-trash-alt "></i></button>
                                                    <script>
