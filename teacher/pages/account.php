                ...
                <div class="container-fluid">
                    <div class="card">
                        ...
                        <form action="update_account" method="post">
                            <div class="card-body">
                                <input type="text" class="form-control" value="<?=$data['user_id'];?>" name="user_id"
                                    style="display: none;">
                                <div class="mb-3">
                                    <div class="row">
                                        <div class="col" style="max-width:150px ;">
                                            <label for=" " class="form-label">คำนำหน้า</label>
                                            <select class="form-control" id="exampleFormControlSelect1" name="prefix"
                                                required>
                                        ...
                                        <div class="col" style="max-width:660px ;">
                                            ...
                                            <input type="text" class="form-control" placeholder="First name" required
                                                value="<?=$data['f_name'];?>" name="f_name" aria-label="First name">
                                        </div>
                                        <div class="col">
                                            <label for=" " class="form-label">นามสกุล</label>
                                            <input type="text" class="form-control" placeholder="Last name" required
                                                value="<?=$data['l_name'];?>" name="l_name" aria-label="Last name">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            ...
                                            <input type="date" class="form-control" placeholder="Birthday" required
                                                value="<?=$data['birthday'];?>" name="birthday" aria-label="birthday">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            ...
                                            <input type="text" class="form-control" placeholder="Username" required
                                                value="<?=$data['username'];?>" name="username" aria-label="Username">
                                        </div>
                                        <div class="col">
                                            <label for=" " class="form-label">รหัสผ่าน</label>
                                            <input type="password" class="form-control" placeholder="Password" required
                                                id="password" value="<?=$data['password'];?>" name="password"
                                                aria-label="Password">
                                            <input type="checkbox" style="margin-top:15px; margin-left: 20px;"
                                                onclick="myFunction1()">
                                            เเสดงรหัสผ่าน
                            ...
                            <div class="modal-footer">
                                <button type="submit" name="update" class="btn btn-success"><i
                                        class="fa-solid fa-pen-to-square"></i> บันทึก</button>
                            </div>
                        </form>
