                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <table id="example1" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $stmt = $conn->query("SELECT * FROM db_user WHERE status = 'student' OR status = 'teacher' ");
                                    $stmt->execute();
                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title" id="exampleModalLabel"><i class="fa-solid fa-pen-to-square"></i>
                                                                            แก้ไขข้อผู้สอน | <?= $alldata['username']; ?>
                                                                        </h5>
                                                                            ...
                                                                            <div class="mb-3">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col">
                                                                                        ...
                                                                                        <input type="text" class="form-control" value="<?= $alldata['password']; ?>" placeholder="Password" required id="password" name="password" aria-label="Password">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                        ...
                                                        <div class="modal fade" id="exampleModal<?= $alldata['user_id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                            <div class="modal-dialog modal-xl">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title" id="exampleModalLabel"><i class="fa-solid fa-pen-to-square"></i>
                                                                            แก้ไขข้อนักเรียน | <?= $alldata['username']; ?>
                                                                        </h5>
                                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                            <span aria-hidden="true">&times;</span>
                                                                        </button>
                                                                        ...
                                                                        <div class="modal-body">
                                                                            ...
                                                                            <div class="mb-3">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col">
                                                                                        <label for=" " class="form-label">รหัสผ่าน</label>
                                                                                        <input type="text" class="form-control" value="<?= $alldata['password']; ?>" placeholder="Password" required id="password<?= $alldata['user_id']; ?>" name="password" aria-label="Password">
