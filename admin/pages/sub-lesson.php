...
<body class="hold-transition sidebar-mini layout-fixed">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <table id="example1" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $stmt = $conn->query("SELECT * FROM db_sub_lesson INNER JOIN db_main_lesson ON  db_sub_lesson.main_id = db_main_lesson.main_id ORDER BY  sub_name  ASC ");
                                    $stmt->execute();
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <select class="form-control" id="exampleFormControlSelect1" name="main_id" required>
                                                                        <option value="<?= $data_sub['main_id']; ?>">บทเรียนหลัก : <?= $data_sub['name']; ?></option>
                                                                        <?php
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <textarea class="form-control" id="summernote<?= $data_sub['sub_id']; ?>" rows="3" name="sub_detail"><?= $data_sub['sub_detail']; ?></textarea>
    ...
    ?>
            <script>
                // Summernote
                $('#summernote<?= $data_sub['sub_id']; ?>').summernote({
                    height: 100
                })
            </script>
    <?php
