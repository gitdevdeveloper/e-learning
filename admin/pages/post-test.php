                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 100px;">
                                            <button type="button" class="btn btn-primary" data-toggle="modal"
                                                data-target="#exampleModal<?=$posttest_main['main_id'];?>">
                                                <i class="fa-solid fa-eye"></i>
                                            </button>

                                            <!-- Modal -->
                                            <div class="modal fade" id="exampleModal<?=$posttest_main['main_id'];?>"
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="formGroupExampleInput"
                                                                    class="form-label">ข้อ <?=$choicenumber;?> <a
                                                                        href="update_question_post?question=<?=$datapretest['question'];?>">แก้ไข</a>
