<?php
        ...
        if (isset($_GET['question'])) {
            ...
            $stmt = $conn->query("SELECT * FROM db_pretest INNER JOIN  db_pretest_choice ON  db_pretest.pre_id = db_pretest_choice.pre_id 
                                                            INNER JOIN db_main_lesson ON db_pretest.main_id = db_main_lesson.main_id
                                                            WHERE db_pretest.question = '$question'");
            $stmt->execute();
            $pertest = $stmt->fetch();
        ...
        if (isset($_POST['update'])) {
            ...
            $sql = $conn->prepare("UPDATE db_pretest SET question = :question ,answer = :answer  WHERE pre_id  = :pre_id ");
            $sql->bindParam(":pre_id", $pre_id );
            ...
            if ($sql) {
                ...
                $sql2 = $conn->prepare("UPDATE db_pretest_choice SET pre_id = :pre_id ,choice1 = :choice1 ,choice2 = :choice2 ,choice3 = :choice3 ,choice4 = :choice4   WHERE choice_id  = :choice_id ");
                $sql2->bindParam(":choice_id", $choice_id );
                $sql2->bindParam(":pre_id", $pre_id);
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item "><a href="pre-test">แบบทดสอบก่อนเรียน</a></li>
                                <li class="breadcrumb-item active">แก้ไขแบบทดสอบก่อนเรียน</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="card">
                        <h5 class="card-header"><i class="fa-solid fa-pen-to-square"></i> แบบทดสอบก่อนเรียน</h5>

                        <form action="" method="post">
                            <div class="card-body">
                                <input type="hidden" class="form-control" id="" name="pre_id"
                                    value="<?=$pertest['pre_id'];?>">

                                <input type="hidden" class="form-control" id="" name="choice_id"
                                    value="<?=$pertest['choice_id'];?>">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="formGroupExampleInput" name="question"
                                        value="<?=$pertest['question'];?>" required>
                                </div>
                                <div class="choice" style="margin-left:50px ;">
                                    <div class="input-group mb-3">
                                        <span class="input-group-text" id="basic-addon1">ก</span>
                                        <input type="text" class="form-control" value="<?=$pertest['choice1'];?>"
                                ...
                                <div class="choice" style="margin-left:50px ;">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="choice2"
                                            value="<?=$pertest['choice2'];?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="choice" style="margin-left:50px ;">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="choice3"
                                            value="<?=$pertest['choice3'];?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="choice" style="margin-left:50px ;">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="choice4"
                                            value="<?=$pertest['choice4'];?>" required>
                                    </div>
                                </div>
                                <div class="mb-3">
